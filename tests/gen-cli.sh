...
# all types of client
./portguard gen-cli -c test.toml -i ./pgcli -o normal.exe -n normal -t 127.0.0.1:8022
./portguard gen-cli -c test.toml -i ./pgcli -o socks5.exe -n socks5 -t socks5
./portguard gen-cli -c test.toml -i ./pgcli -o rclient.exe -n rclient -s 1 -t 127.0.0.1:8022
